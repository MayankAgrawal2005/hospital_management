              ...
              {appointments.map((a) => (
                ...
                >
                  <div className="flex items-start gap-5">
                    ...
                    <div>
                      <h3 className="font-bold text-gray-900 dark:text-white text-xl">Dr. {a.doctorId?.name}</h3>
                      <p className="text-gray-500 dark:text-gray-400 text-sm mb-2">{a.doctorId?.email}</p>
                      <div className="font-semibold text-blue-700 dark:text-blue-300 flex items-center gap-2 text-sm bg-blue-50 dark:bg-blue-900/30 w-max px-3 py-1.5 rounded-lg">
